...
namespace Engine
{
    public static class World
    {
        ...
        {
            //Weapons
            Items.Add(new Weapon(ITEM_ID_RUSTY_SWORD, "Rusty sword", "Rusty swords", 0, 5,5 ,Properties.Resources.Rusty_Sword_WithBackground));
            Items.Add(new Weapon(ITEM_ID_CLUB, "Club", "Clubs", 3, 10,8,Properties.Resources.Club_WithBackGround));
            ...
            //Healing
            Items.Add(new HealingPotion(ITEM_ID_HEALING_POTION, "Healing potion", "Healing potions", 5, 3,Properties.Resources.HealingPotion_WithBackGround2));
        }
        private static void PopulateMonsters()
        {
            Monster rat = new Monster(MONSTER_ID_RAT, "Rat", 5, 3, 10, 3, 3, Properties.Resources.Rat_WithBackground);
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_RAT_TAIL), 75, false));
            rat.LootTable.Add(new LootItem(ItemByID(ITEM_ID_PIECE_OF_FUR), 75, true));

            Monster snake = new Monster(MONSTER_ID_SNAKE, "Snake", 5, 3, 10, 3, 3,Properties.Resources.Snake_WithBackground);
            snake.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SNAKE_FANG), 75, false));
            snake.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SNAKESKIN), 75, true));

            Monster giantSpider = new Monster(MONSTER_ID_GIANT_SPIDER, "Giant spider", 20, 5, 40, 10, 10,Properties.Resources.Giant_Spider_WithBackground);
        ...
        private static void PopulateLocations()
        {
            ...
            bobTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_RAT_TAIL), 5);
